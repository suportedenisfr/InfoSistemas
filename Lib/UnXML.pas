...
begin
  ...
  XMLEnvio.AddChild('Pessoa');
  XMLEnvio.DocumentElement.ChildNodes['Dados'].AddChild('Nome').NodeValue := prPessoa.Nome;
  XMLEnvio.DocumentElement.ChildNodes['Dados'].AddChild('Identidade').NodeValue := prPessoa.Identidade;
  XMLEnvio.DocumentElement.ChildNodes['Dados'].AddChild('CPF').NodeValue := prPessoa.CPF;
  XMLEnvio.DocumentElement.ChildNodes['Dados'].AddChild('Telefone').NodeValue := prPessoa.Telefone;
  XMLEnvio.DocumentElement.ChildNodes['Dados'].AddChild('Email').NodeValue := prPessoa.Email;
